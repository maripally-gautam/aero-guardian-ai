        ...
        <div className="premium-card p-10 text-center">
          ...
          >
            <Button
              ...
              disabled={signingIn}
              size="lg"
              className="w-full font-heading text-lg h-14 px-8 gradient-primary text-primary-foreground hover:opacity-90 glow-primary transition-all duration-500 hover:scale-[1.02] rounded-xl disabled:opacity-50"
            >
              {signingIn ? (
                <>
