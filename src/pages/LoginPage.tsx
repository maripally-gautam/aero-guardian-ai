  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background grid-bg relative overflow-hidden">
      ...
      <motion.div
        ...
        className="relative z-10 glass-strong rounded-2xl p-10 max-w-md w-full mx-4 text-center"
      >
        <motion.div
          initial={{ scale: 0 }}
          animate={{ scale: 1 }}
          transition={{ delay: 0.3, type: "spring", stiffness: 200 }}
          className="w-20 h-20 mx-auto mb-6 rounded-2xl bg-primary/10 flex items-center justify-center glow-cyan"
        >
        ...
        <motion.h1
          ...
          className="font-display text-3xl font-bold text-primary glow-text mb-2"
        >
          AeroGuardian AI
        </motion.h1>
        ...
        >
          <Button
            onClick={handleLogin}
            size="lg"
            className="w-full font-heading text-base bg-primary text-primary-foreground hover:bg-primary/90 glow-cyan transition-all duration-300 hover:scale-105"
          >
